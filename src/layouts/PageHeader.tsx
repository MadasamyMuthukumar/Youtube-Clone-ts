...
export function PageHeaderFirstSection({ showFullWidthSearch = false }: PageHeaderFirstSectionProps) {
    ...
    <div className={`gap-4 items-center flex-shrink-0  ${showFullWidthSearch ? "hidden" : "flex"}`}>
        {/* /**
    when it was clicked then toggle will happen according to screen size seperately */ }
